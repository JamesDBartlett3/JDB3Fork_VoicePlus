      ...
      ListItem(
        ...
        headlineContent = {
          Row(
            ...
            Text(
              ...
              text = stringResource(
                when (bookmark.type) {
                  BookmarkType.Manual -> StringsR.string.bookmark_type_manual
                  BookmarkType.QuickBookmark -> StringsR.string.bookmark_type_quick
                  BookmarkType.SleepTimer -> StringsR.string.bookmark_type_sleep_timer
                },
              ),
        ...
        supportingContent = {
          Column {
            Text(
              text = stringResource(
                StringsR.string.bookmark_position,
                bookmark.chapterPosition,
                bookmark.bookPosition,
              ),
            )
            Text(
              text = stringResource(
                StringsR.string.bookmark_saved,
...
private fun BookmarkItemPreview() {
  BookmarkItem(
    bookmark = BookmarkItemViewState(
      title = "Bookmark 1",
      chapterPosition = "10:10",
      bookPosition = "12:12:12",
      addedAt = java.time.Instant.now(),
      type = BookmarkType.QuickBookmark,
